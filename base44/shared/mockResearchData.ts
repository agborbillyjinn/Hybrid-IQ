...
export function buildMockPayload(companyName, analysisId) {
  ...
  return {
    ...
    attack_plan: {
      ...
      why_now: "NAV 2018 mainstream support ending; ERP Transformation Lead hired; PE transformation mandate",
      primary_persona: "CFO",
      secondary_persona: "CIO",
      economic_buyer: "CFO",
      champion: "ERP Transformation Lead",
      primary_pain: "End-of-support ERP with customisation debt and manual consolidation",
      commercial_hypothesis: "£1.8m traditional → £1.0m AI-enabled (44% reduction, £0.8m saving, 7 months faster)",
      primary_objection: "C/Side rewrite effort and MES integration risk",
      entry_point: "ERP Transformation Lead (recently hired)",
      discovery_goal: "Confirm budget, timeline, customisation inventory and decision process",
